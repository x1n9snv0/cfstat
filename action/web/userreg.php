                ...
                $(function () {
                    $("#username").mouseleave(function () {
                        ...
                        $.ajax({
                            url: "?",
                            type: "post",
                            data: "action=usernamechecksave&username=" + username,
                ...
                <form name="form2" id="form2" method="post" action="?action=userregsave">
                    <tr>
                        ...
                        <td><input type="text" name="username" id="username" autoComplete="off"
                                   STYLE="ime-mode:inactive;width:220px">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <INPUT type="image" name="userreg" id="userreg" src="images/reg.gif"
                                   style="width:53px;height:21px;border:0;margin:8px 0">
                            <?php
