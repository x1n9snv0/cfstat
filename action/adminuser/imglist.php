...
<tr> 
 <td colspan="3"><iframe style="top:2px" ID="UploadFiles" src="cf_upfile.php?usertype=2" frameborder=0 scrolling=no width="600" height="25" allowtransparency="true"></iframe></td>
</tr>
...
echo "上传人：";
if($rs["username"]==""){echo "管理员";}else{echo $rs["username"];}
echo "<br>";
...
<table class="tb_3">
                <tr> 
                  <td> <a href="?action=<?php echo $action;?>&imgtype=<?php echo $imgtype;?>&page=1">第一页</a> 
                      ...
                      <?php }?>
                      <a href="?action=<?php echo $action;?>&imgtype=<?php echo $imgtype;?>&page=<?php echo $totalpage;?>">最后一页</a>&nbsp;共<font color="#FF0000"><?php echo $totalrs?></font>条记录&nbsp;<font color="#ff0000"><?php echo $page;?></font>/<?php echo $totalpage;?>页
<?php 
