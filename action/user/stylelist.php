          ...
          <form name="form4" method="post" action="?action=stylemodifysave">
            ...
            <tr> 
              <td>  
				  ...
				  ?>
                  <input name="style" type="radio" value="<?php echo $k;?>"<?php if($rs["style"]==$k) echo " checked";?>>
              </td>
              <td><?php for($j=0;$j<=9;$j++){?><img src="counterpic/<?php echo $k;?>/<?php echo $j;?>.gif"><?php }?>
              </td>
            </tr>
            <?php 
$i=$i+1;
...
?></td>
          ...
          <tr> 
            <td colspan="2"><script src="<?php echo $tmp;?>cf.php?username=<?php echo $username;?>"></script></td>
          </tr>
        </table>