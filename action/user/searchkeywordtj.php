...
<table class="tb_1">
  <form name="form2" method="post" action="?action=<?php echo $action;?>">
    <tr> 
      <td colspan="6"> <select  name="siteflag" size="1" id="siteflag">
...
;}
?>
        </select> <select  name="adddate" size="1" id="adddate">
...
?>
  ...
  <tr class="tr_2"> 
    <td class="td_nowrap"><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=keyword">关键字</a></td>
    <td class="td_nowrap"><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=mycounter">PV数量</a></td>
    <td class="td_nowrap"><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=ipcounter">IP数量</a></td>
    <td class="td_nowrap"><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=addtime">第一次访问</a></td>
    <td class="td_nowrap"><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=lasttime">最后访问时间</a></td>
    <td><a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=lastly">最后来源</a></td>
  </tr>
  <?php 
...
<table class="tb_3">
                <tr> 
                  <td> <a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=<?php echo $px;?>&page=1">第一页</a> 
                      <?php if($page>1){?>
                      ...
                      <?php }?>
                      <a href="?action=<?php echo $action;?>&siteflag=<?php echo $siteflag;?>&adddate=<?php echo $adddate;?>&px=<?php echo $px;?>&page=<?php echo $totalpage;?>">最后一页</a>&nbsp;共<font color="#FF0000"><?php echo $totalrs?></font>条记录&nbsp;<font color="#ff0000"><?php echo $page;?></font>/<?php echo $totalpage;?>页
<?php 
