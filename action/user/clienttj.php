...
<table class="tb_1">
    <tr>
        <td colspan="4">
            <select id='adddate'
                    onChange="window.location=document.getElementById('adddate').options[document.getElementById('adddate').selectedIndex].value">
    ...
    <tr>
        ...
        <td><?php echo $rs["screenwidth1"]; ?>/<?php echo $rs["screenwidth2"]; ?>/<?php echo $rs["screenwidth3"]; ?>
            /<?php echo $rs["screenwidth4"]; ?>/<?php echo $rs["screenwidth5"]; ?>/<?php echo $rs["screenwidth6"]; ?>
            /<?php echo $rs["screenwidth7"]; ?>/<?php echo $rs["screenwidth8"]; ?>/<?php echo $rs["screenwidth9"]; ?>
            /<?php echo $rs["screenwidthother"]; ?></td>
    </tr>
    <tr>
        <td class="td_3">屏幕高768/800/900/1024/864/1050/960/720/600/其它：</td>
        <td><?php echo $rs["screenheight1"]; ?>/<?php echo $rs["screenheight2"]; ?>/<?php echo $rs["screenheight3"]; ?>
            /<?php echo $rs["screenheight4"]; ?>/<?php echo $rs["screenheight5"]; ?>/<?php echo $rs["screenheight6"]; ?>
            /<?php echo $rs["screenheight7"]; ?>/<?php echo $rs["screenheight8"]; ?>/<?php echo $rs["screenheight9"]; ?>
            /<?php echo $rs["screenheightother"]; ?></td>
    </tr>
    <tr>
        <td class="td_3">屏幕色彩32位/16位/24位/其它：</td>
        <td><?php echo $rs["screencolordepth1"]; ?>/<?php echo $rs["screencolordepth2"]; ?>
            /<?php echo $rs["screencolordepth3"]; ?>/<?php echo $rs["screencolordepthother"]; ?></td>
    </tr>
</table>
