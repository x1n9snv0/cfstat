<style type="text/css">
.tb_1{border:1px solid <?php echo $tablebordercolor;?>; margin:5px 0px 5px 5px; width:758px;float:right;}
...
.tb_2{width:960px;border:1px solid <?php echo $tablebordercolor;?>;margin:0px auto;margin-top:10px; clear:both;border-collapse:collapse;}
