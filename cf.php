...
if($firstshow==1)
{
$sql = "update cfstat_client_day set ";
if($alexa==1){$sql= $sql." alexacounter=alexacounter+1,";}
...
{
$mycode="<a href=".$tmp."cf.php?action=countgo&username=".$username." target=_blank title=".$counttitle."><span style=font-size:12>统计</span></a>";
echo "document.write('".$mycode."');";
}
...
$mystr .= "             +'         <iframe src=\"".$tmp."cf_gbook.php?action=gbookcodeget&username=".$username."&ly=".urlencode($ly)."&currweb=".urlencode($currweb)."\" width=\"194\" height=\"' + iframeheight + '\" frameborder=\"0\" marginheight=0 marginwidth=0 scrolling=no id=\"tab_c_iframe\"></iframe>'   ".chr(13).chr(10);
$mystr .= "             +'        </td>'    ".chr(13).chr(10);
$mystr .= "             +'        </tr>'    ".chr(13).chr(10);
